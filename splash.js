...
function prepopulate () {
  ...
  allCharacters[0].renderURL = 'existingcharacter.html?name=' + allCharacters[0].quizOne[1];
  ...
  allCharacters[1].renderURL = 'existingcharacter.html?name=' + allCharacters[1].quizOne[1];
  ...
  allCharacters[2].renderURL = 'existingcharacter.html?name=' + allCharacters[2].quizOne[1];
  ...
  allCharacters[3].renderURL = 'existingcharacter.html?name=' + allCharacters[3].quizOne[1];
